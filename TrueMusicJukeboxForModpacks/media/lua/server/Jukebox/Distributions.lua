...
JukeboxDistribution.addBooks = function()
    ...
    if SandboxVars.TrueMusicJukebox and SandboxVars.TrueMusicJukebox.jukeboxLiteratureFrequencyMultiplier then
        rateForBooks = rateForBooks * SandboxVars.TrueMusicJukebox.jukeboxLiteratureFrequencyMultiplier
    end
    ...
    if rateForJukeboxStarterKits > 0 then
