...
JukeboxFeedback = JukeboxFeedback or ISPanel:derive("JukeboxFeedback")

function JukeboxFeedback:show(message)

    self.displayTime = Jukebox.mod.options.accessibilityModeDisplayTime * (2 * Jukebox.oneRealHalfSecond)
...
function JukeboxFeedback:new(width, height, background)
	...
	o.displayTime = Jukebox.mod.options.accessibilityModeDisplayTime * (2 * Jukebox.oneRealHalfSecond)
