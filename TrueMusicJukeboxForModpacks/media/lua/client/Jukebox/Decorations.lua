...
function JukeboxMisuseAlert:new(x, y, width, height, player, url, alert, subtext, workshop)
    ...
    o.subtext = subtext
    o.workshop = workshop
    o.textX1 = (o.width / 2) - (getTextManager():MeasureStringX(UIFont.Large, o.alert) / 2)
    o.textX2 = (o.width / 2) - (getTextManager():MeasureStringX(UIFont.Large, o.subtext) / 2)
    o.textX3 = (o.width / 2) - (getTextManager():MeasureStringX(UIFont.Large, o.workshop) / 2)
    o.textY1 = (getCore():getScreenHeight() / 6) - (3 * (JukeboxMisuseAlert.fontHeightLarge / 2)) - 10
    o.textY2 = (getCore():getScreenHeight() / 6) - (JukeboxMisuseAlert.fontHeightLarge / 2)
    o.textY3 = (getCore():getScreenHeight() / 6) + (JukeboxMisuseAlert.fontHeightLarge / 2) + 10
