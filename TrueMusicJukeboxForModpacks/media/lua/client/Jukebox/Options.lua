...
function GameOptions:apply()
    ...
    if considerDistanceActivated and ignoreDistanceIsOn then
    ...
    elseif ignoreDistanceActivated and considerDistanceIsOn then
    ...
    elseif ignoreDistanceIsOn and considerDistanceIsOn then
