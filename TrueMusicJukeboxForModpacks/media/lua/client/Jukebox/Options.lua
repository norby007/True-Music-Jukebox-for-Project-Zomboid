...
function GameOptions:apply()
    ...
    elseif ignoreDistanceIsOn then
        Jukebox.GameOptions.flipper = true
    elseif considerDistanceIsOn then
        Jukebox.GameOptions.flipper = false
    end
...
function MainOptions:create()
    ...
    Jukebox.GameOptions.flipper = Jukebox.options.ignoreDistanceWhenPlayingOverride
    ...
    JukeboxOptions.blockTrueMusicJukeboxSound = JukeboxMenus.addCheckboxOption(self, 
        "blockTrueMusicJukeboxSound", splitPoint, y, comboWidth)
