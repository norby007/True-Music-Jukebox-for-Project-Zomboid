...
Jukebox.updateSound = function()
	...
	for index = #keyData, 1, -1 do repeat
		...
		if sound:isPlaying() then
			...
			if sound.audibleVolume == 0 and not Jukebox.firstSilentKey then
				Jukebox.firstSilentKey = key
			elseif sound.audibleVolume > 0 then
				Jukebox.firstSilentKey = nil
				Jukebox.silentForLocals = nil
			elseif Jukebox.firstSilentKey == key then
